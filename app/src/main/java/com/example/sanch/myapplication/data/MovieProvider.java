...
public class MovieProvider extends ContentProvider {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE: {
                retCursor = mOpenHelper.getReadableDatabase().query(
                                         MovieDbContract.MovieEntry.TABLE_MOVIES, projection, selection, selectionArgs,
                                         null, null, sortOrder);
                break;
            }
            default:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE: {
                long _id = db.insert(MovieDbContract.MovieEntry.TABLE_MOVIES, null, values);
                if (_id > 0) {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE:
                ...
                rowsDeleted = db.delete(MovieDbContract.MovieEntry.TABLE_MOVIES, selection, selectionArgs);
                break;
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE:
                ...
                rowsUpdated = db.update(MovieDbContract.MovieEntry.TABLE_MOVIES, values, selection,
                        selectionArgs);
                break;
